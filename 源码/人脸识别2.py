...
facerec = dlib.face_recognition_model_v1("D:/try45/dlib_face_recognition_resnet_model_v1.dat")
...
# 处理存放所有人脸特征的 csv
path_features_known_csv = "D:/try45/features2_all.csv"
            ...
            for k in range(len(faces)):
                ...
                if min(e_distance_list) < 0.4:
                    ...
                    for i, d in enumerate(faces):
                        ...
                        # 要存储visitor人脸图像文件的路径
                        path_visitors_save_dir = "D:/faces/known"
                    ...
                    for i, d in enumerate(faces):
                        ...
                        path_visitors_save_dir = "D:/faces/unknown"
